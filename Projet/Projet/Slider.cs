...
namespace Projet
{
    public struct Slider
    {
        ...
        public static void GenerateSlider()
        {
            ...
            Navigation.AddSlider(0, new Slider("Légende", value00, interval00, 2, 0, 3));
            string[] value01 = { "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*" };
            string[] interval01 = { "5", "100" };
            Navigation.AddSlider(1, new Slider("Largeur", value01, interval01, 6, 9, 2));
            string[] value02 = { "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*" };
            string[] interval02 = { "5", "100" };
            Navigation.AddSlider(2, new Slider("Hauteur", value02, interval02, 10, 9, 2));
            string[] value03 = { "Réaliste", "Consigne" };
            string[] interval03 = { null };
            Navigation.AddSlider(3, new Slider("Icone", value03, interval03, 14, 0, 1));
            string[] value04 = { "Activé", "Désactivé" };
            string[] interval04 = { null };
            Navigation.AddSlider(4, new Slider("Propagation du feu", value04, interval04, 18, 0, 1));

            string[] value05 = {"*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*", "*" };
            string[] interval05 = { "5", "200"};
            Navigation.AddSlider(5, new Slider("Fréquence arbres", value05, interval05, 22, 9, 2));
            Navigation.AddSlider(6, new Slider("Fréquence eau", value05, interval05, 26, 9, 2));
            Navigation.AddSlider(7, new Slider("Fréquence feuilles", value05, interval05, 30, 9, 2));
            Navigation.AddSlider(8, new Slider("Fréquence rochers", value05, interval05, 34, 9, 2));
            Navigation.AddSlider(9, new Slider("Fréquence herbe", value05, interval05, 38, 9, 2));
